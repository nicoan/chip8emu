    ...
    loop {
        ...
        if input.is_key_event() {
            match input.event_type() {
                EventType::Push => {
                    match input.get_key() {
                        Keys::KEY_1 => { return KeyboardCommand::SingleKey(1); },
                        Keys::KEY_2 => { return KeyboardCommand::SingleKey(2); },
                        Keys::KEY_3 => { return KeyboardCommand::SingleKey(3); },
                        Keys::KEY_4 => { return KeyboardCommand::SingleKey(4); },
                        Keys::KEY_Q => { return KeyboardCommand::SingleKey(5); },
                        Keys::KEY_W => { return KeyboardCommand::SingleKey(6); },
                        Keys::KEY_E => { return KeyboardCommand::SingleKey(7); },
                        Keys::KEY_R => { return KeyboardCommand::SingleKey(8); },
                        Keys::KEY_A => { return KeyboardCommand::SingleKey(9); },
                        Keys::KEY_S => { return KeyboardCommand::SingleKey(10); },
                        Keys::KEY_D => { return KeyboardCommand::SingleKey(11); },
                        Keys::KEY_F => { return KeyboardCommand::SingleKey(12); },
                        Keys::KEY_Z => { return KeyboardCommand::SingleKey(13); },
                        Keys::KEY_X => { return KeyboardCommand::SingleKey(14); },
                        Keys::KEY_V => { return KeyboardCommand::SingleKey(15); },
                        Keys::KEY_C => { return KeyboardCommand::SingleKey(16); },
                        Keys::KEY_O => { return KeyboardCommand::Quit;},
